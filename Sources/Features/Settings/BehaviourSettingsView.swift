    ...
    var body: some View {
        ...
        Form {
            Section {
                ...
                Text("Parma Master uses your location to find pubs. After you have stayed for the selected time it shows a prompt on Home and sends a notification. Choose “Always” so this still works when the app is closed.\n\n\(pubDetection.diagnosticsSummary)")
            }
